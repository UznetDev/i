...
# Ta'rifi:
# Dictionary, kalit va qiymat juftliklarini saqlash uchun ishlatiladi.
# Har bir kalit unikal bo'lishi kerak.

# Mavzu bo'yicha ma'lumot:
# Dictionary lar ko'p elementlarni saqlaydi va har bir elementning unikal kaliti bo'lishi kerak.
# Misol uchun: {'apple': 5, 'banana': 2, 'cherry': 7}.

# Farqlari:
# Dict lar to'g'ri joylashgan kalitlar bilan indekslanadi va shu kalitlar orqali qiymatga murojat qilinadi.
# Bu, elementlarni boshqarish uchun tezkor va samarali yechim beradi.
